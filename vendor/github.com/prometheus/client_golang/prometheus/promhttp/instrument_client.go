...
// to the set. Partitioning of the CounterVec happens by HTTP status code
// and/or HTTP method if the respective instance label names are present
...
// names are "code" and "method". The function panics if any other instance
// labels are provided. For the "method" label a predefined default label value
// set is used to filter given values. Values besides
// predefined values will count as `unknown` method. `WithExtraMethods`
// can be used to add more methods to the set. The Observe method of the
// Observer in the ObserverVec is called with the request duration in seconds.
