...
%{!?commit:
%global commit 49f5dbf0e4b1bc57d64b7fae7fc1bd0b9b85d594
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=49f5dbf0 OS_GIT_VERSION=v3.7.0-0.rc.0.4.4ba92a6+49f5dbf-1 OS_GIT_MAJOR=3 OS_GIT_MINOR=7+ OS_GIT_TREE_STATE=clean
}
...
Version:        3.7.0
Release:        0.0.rc.0.4.4ba92a6.1.49f5dbf
