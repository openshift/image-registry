...
require (
	...
	github.com/openshift/library-go v0.0.0-20220211142501-9f57c596fd46
...
replace (
	github.com/docker/distribution => github.com/openshift/docker-distribution v2.5.0-rc.1.0.20220623174125-9735981ba0a8+incompatible
