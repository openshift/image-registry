...
require (
	...
	github.com/openshift/library-go v0.0.0-20220505183534-f2c20ff2ad27
...
replace (
	github.com/docker/distribution => github.com/openshift/docker-distribution v2.5.0-rc.1.0.20230317150742-a788b04c05e2+incompatible
