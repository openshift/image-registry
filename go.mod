...
require (
	...
	github.com/distribution/distribution/v3 v3.0.0-20260730133306-e4a5c6704ae7
...
replace (
	github.com/distribution/distribution/v3 => github.com/openshift/docker-distribution/v3 v3.0.0-20260730133306-e4a5c6704ae7
...
// See: https://github.com/googleapis/google-cloud-go/blob/main/storage/CHANGES.md#1550
