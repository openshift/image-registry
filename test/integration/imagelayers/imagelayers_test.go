...
func TestImageLayers(t *testing.T) {
	...
	image1LayerOrder := schema1ISTag.Image.Annotations[imageapiv1.DockerImageLayersOrderAnnotation]
	image2LayerOrder := schema2ISTag.Image.Annotations[imageapiv1.DockerImageLayersOrderAnnotation]
